...
function summarySheet(
  ...
  const rows: SheetData = [
    ...
    [label('Application URL'), text(engagement.applicationUrl ?? '-', { columnSpan: 3 })],
    ...
    [label('Additional scope'), text(engagement.scope.join('\n') || '-', { columnSpan: 3 })],
    ...
    [label('Tests in library'), num(c.total), label('Total applicable tests'), num(c.applicable)],
    [label('Not applicable (excluded)'), num(c.excluded), label('Not tested'), num(c.notTested)],
    [label('Tested'), num(c.tested), label('N/A'), num(c.na)],
    [label('Vulnerable'), num(c.vulnerable), label('Not vulnerable'), num(c.notVulnerable)],
    [
      label('Completed (Tested + N/A)'),
      num(completedOf(c)),
      label('Awaiting result'),
      num(c.awaitingResult),
    ],
    [
