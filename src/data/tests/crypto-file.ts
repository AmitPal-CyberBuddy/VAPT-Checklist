...
export const cryptoTests: TestDefinition[] = [
  ...
  },
  {
    ...
    cwe: ['CWE-209', 'CWE-347'],
    applicability: rule.always(),
    aliases: ['Padding Oracle', 'CBC Padding Attack', 'Decryption Oracle'],
    tags: ['crypto'],
  },
  {
    id: 'CRYPTO-006',
  ...
  },
  {
    ...
    cwe: ['CWE-353'],
    applicability: rule.always(),
    aliases: ['Bit Flipping Attack', 'CBC Bit Flipping', 'Unauthenticated Encryption'],
    tags: ['crypto'],
  },
];
...
export const fileTests: TestDefinition[] = [
  ...
  },
  {
    ...
    aliases: ['Arbitrary File Read', 'File Download Traversal', 'Unrestricted File Download'],
    tags: ['file-download'],
  },
  {
    id: 'FILE-007',
