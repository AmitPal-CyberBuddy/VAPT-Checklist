...
export const clientSideTests: TestDefinition[] = [
  {
    ...
    aliases: ['DOM XSS', 'DOM-Based XSS', 'Type-0 XSS', 'Client-Side XSS'],
  ...
  },
  {
    ...
    cwe: ['CWE-1021'],
    applicability: browser,
    aliases: ['Clickjacking', 'UI Redress Attack', 'Frame Injection'],
    tags: ['client-side'],
  },
  {
    id: 'CLI-003',
    ...
    cwe: ['CWE-922'],
    applicability: browser,
    aliases: ['Sensitive Data in localStorage', 'Token in Browser Storage', 'Client-Side Data Leakage'],
    tags: ['client-side'],
  },
  {
    id: 'CLI-004',
    ...
    aliases: ['CORS Misconfiguration', 'Permissive Access-Control-Allow-Origin', 'Origin Reflection'],
  ...
  },
  {
    ...
    cwe: ['CWE-346'],
    applicability: browser,
    aliases: ['postMessage Vulnerability', 'Insecure Web Messaging', 'Missing Origin Validation'],
    tags: ['client-side'],
  },
  {
    id: 'CLI-006',
    ...
    aliases: ['Prototype Pollution', '__proto__ Injection'],
    tags: ['client-side'],
  },
  {
    id: 'CLI-007',
    ...
    cwe: ['CWE-601'],
    applicability: browser,
    aliases: ['DOM Open Redirect', 'JavaScript URI Injection'],
    tags: ['client-side'],
  },
  {
    id: 'CLI-008',
    ...
    cwe: ['CWE-494'],
    applicability: browser,
    aliases: ['Script Source Manipulation', 'Remote Resource Injection'],
    tags: ['client-side'],
  },
  {
    id: 'CLI-012',
  ...
  },
  {
    ...
    aliases: ['Tabnabbing', 'window.opener Hijacking'],
    tags: ['client-side'],
  },
  {
    id: 'CLI-010',
    ...
    category: 'client-side',
    subcategory: 'Real-Time Channels',
    priority: 'Medium',
    description:
    ...
    aliases: ['Cross-Site WebSocket Hijacking', 'CSWSH', 'WebSocket Origin Bypass'],
  ...
  },
  {
    ...
    aliases: ['Supply Chain Attack', 'Magecart Exposure', 'Third-Party Script Compromise'],
...
export const businessLogicTests: TestDefinition[] = [
  {
    ...
    subcategory: 'Workflow Integrity',
    priority: 'High',
    description:
    ...
    aliases: ['Process Flow Bypass', 'Step Skipping', 'Workflow Circumvention'],
    tags: ['business-logic'],
  },
  {
    id: 'LOGIC-002',
    ...
    category: 'business-logic',
    subcategory: 'Transaction Integrity',
    priority: 'Critical',
    description:
    ...
    aliases: ['Price Manipulation', 'Quantity Tampering', 'Shopping Cart Manipulation'],
    tags: ['business-logic'],
  },
  {
    id: 'LOGIC-003',
    ...
    aliases: ['Coupon Abuse', 'Promo Code Stacking', 'Voucher Reuse'],
    tags: ['business-logic'],
  },
  {
    id: 'LOGIC-004',
    ...
    cwe: ['CWE-362'],
    applicability: rule.is('hasWorkflowOrTransactions', true),
    aliases: ['Race Condition', 'TOCTOU', 'Double Spending', 'Concurrency Flaw'],
    tags: ['business-logic'],
  },
  {
    id: 'LOGIC-005',
    ...
    aliases: ['Missing CAPTCHA', 'Automated Abuse', 'Scraping Exposure', 'Bot Protection Bypass'],
    tags: ['business-logic'],
  },
  {
    id: 'LOGIC-007',
    ...
    category: 'business-logic',
    subcategory: 'Trust Boundary',
    priority: 'High',
    description:
      'Security-relevant values and controls delivered from the client — user IDs, roles, tiers, tenant, account status, hidden or disabled fields, feature flags, price and format constraints — are trusted and used by the server without verification or re-enforcement.',
    testingGuidance: [
    ...
    cwe: ['CWE-472', 'CWE-602', 'CWE-20'],
    applicability: rule.always(),
    aliases: ['Parameter Tampering', 'Trusted Value Manipulation', 'Hidden Field Manipulation', 'Disabled Field Bypass', 'Client-Side Control Bypass', 'Improper Input Validation', 'Missing Server-Side Validation', 'Client-Side Only Validation'],
  ...
  },
  {
    ...
    aliases: ['Missing Business Limits', 'Negative Amount Transfer', 'Boundary Value Abuse'],
    tags: ['business-logic'],
  },
  {
    id: 'LOGIC-009',
    ...
    aliases: ['File Type Confusion in Business Flow', 'Unexpected Content Type Accepted'],
    tags: ['business-logic'],
  },
  {
    id: 'LOGIC-010',
    ...
    category: 'business-logic',
    subcategory: 'Authorisation Workflow',
    priority: 'High',
    description:
    ...
    aliases: ['Maker-Checker Bypass', 'Self-Approval', 'Four-Eyes Principle Bypass'],
    tags: ['business-logic'],
  },
  {
    id: 'LOGIC-011',
    ...
    cwe: ['CWE-840'],
    applicability: rule.always(),
    aliases: ['Feature Abuse', 'Resource Abuse', 'Application Mis-use'],
    tags: ['business-logic'],
  },
];
