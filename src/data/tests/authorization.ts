...
export const authorizationTests: TestDefinition[] = [
  {
    ...
    testingGuidance: [
      ...
      'Walk each privilege boundary (anonymous → standard → privileged → administrator)at both function and object level, and check whether crossing it routinely succeeds.',
    ...
    owasp: ['A01:2021', 'WSTG-ATHZ-02', 'WSTG-ATHZ-03'],
    cwe: ['CWE-284', 'CWE-862', 'CWE-269'],
    applicability: auth,
    aliases: ['Missing Access Control', 'Improper Authorization', 'Broken Access Control', 'Vertical Privilege Escalation', 'Admin Function Access by Standard User'],
    tags: ['authorization'],
  },
  {
    id: 'AUTHZ-002',
